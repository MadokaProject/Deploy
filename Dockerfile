...
RUN wget https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6-1/wkhtmltox-0.12.6-1.centos8.x86_64.rpm -P /opt/ && \
    dnf localinstall -y /opt/wkhtmltox-0.12.6-1.centos8.x86_64.rpm && \ 
    yum groupinstall Fonts -y && \
    wget https://raw.githubusercontent.com/MadokaProject/Application/release/requirements.txt -P /root/ && \
